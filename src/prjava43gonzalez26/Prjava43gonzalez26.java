...
public class Prjava43gonzalez26 extends Frame 
   ...
   public Prjava43gonzalez26 () { 
      ...
      setTitle("nova finestra prjava43gonzalez26");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43gonzalez26();  // Let the construct do the job 
   } 
